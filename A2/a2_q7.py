...
clauses.append(expr('Adult(Marge)'))
clauses.append(expr('Children(Lisa)'))
clauses.append(expr('Children(Maggie)'))
clauses.append(expr('Children(Bart)'))
clauses.append(expr('Adult(Homer)'))
clauses.append(expr('(Children(x) & Adult(y)) ==> Parent(y,x)'))
clauses.append(expr('(Children(x) & Adult(y)) ==> Child(x,y)'))
clauses.append(expr('(Children(x) & Children(z)) ==> Sibling(z,x)'))
