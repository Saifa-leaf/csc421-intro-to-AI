...
cpt_l_true = dsp.variable_node('L').cpt[True,]
cpt_l_false = dsp.variable_node('L').cpt[False,]
...
ea_result = enumeration_ask('D', {'A': True, 'X': True}, dsp)
rs_result = rejection_sampling('D', dict(A = True, X = True), dsp, 10000)
lw_result = likelihood_weighting('D', dict(A = True, X = True), dsp, 10000)
